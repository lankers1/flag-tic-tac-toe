...
type Handlers struct {
	...
	GameSearchWebsocketHandler *GameSearchWebsocketHandler
...
func NewHandlers(gameRepo *repositories.GameRepository, flagRepo *repositories.FlagRepository, authRepo *repositories.AuthRepository, userRepo *repositories.UserRepository) *Handlers {
	return &Handlers{
		...
		GameSearchWebsocketHandler: NewGameSearchWebsocketHandler(gameRepo),
		GameWebsocketHandler:       NewGameWebsocketHandler(gameRepo),
	}
}
